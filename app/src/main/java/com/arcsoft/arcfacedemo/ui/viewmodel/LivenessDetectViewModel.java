                ...
                try {
                    ...
                    if (facePreviewInfoList.isEmpty()) {
                        ...
                        if ((livenessMask & FaceEngine.ASF_IR_LIVENESS) != 0) {
                            ...
                            int fdCode = flEngine.detectFaces(irNv21, previewSize.width, previewSize.height, FaceEngine.CP_PAF_NV21, rgbFaceInfoList);
                            if (fdCode == ErrorInfo.MOK && FaceHelper.isFaceSame(rgbFaceInfoList.get(0), irFaceInfo,0.3)) {
