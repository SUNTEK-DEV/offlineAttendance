...
public class FaceRectView extends View {
    ...
    private static void drawFaceRect(Canvas canvas, FaceRectView.DrawInfo drawInfo, int faceRectThickness, Paint paint) {
        ...
        paint.setStrokeWidth(faceRectThickness + 8);
        paint.setShadowLayer(20, 0, 0, drawInfo.getColor());
        paint.setColor(drawInfo.getColor());
        paint.setAlpha(100);
        drawTechCorners(canvas, rect, paint);

        // 第二层：中层发光
        paint.setStrokeWidth(faceRectThickness + 4);
        paint.setShadowLayer(10, 0, 0, drawInfo.getColor());
        paint.setColor(drawInfo.getColor());
        paint.setAlpha(180);
        drawTechCorners(canvas, rect, paint);
        ...
        paint.setShadowLayer(5, 0, 0, 0xFFFFFFFF);
        paint.setColor(0xFFFFFFFF); // 白色高亮
        paint.setAlpha(255);
        drawTechCorners(canvas, rect, paint);

        // 第四层：原色（让颜色更明显）
        paint.setStrokeWidth(faceRectThickness - 2);
        paint.setShadowLayer(0, 0, 0, drawInfo.getColor());
        paint.setColor(drawInfo.getColor());
        paint.setAlpha(255);
        drawTechCorners(canvas, rect, paint);
     ...
     * 绘制科技感四角
     */
    private static void drawTechCorners(Canvas canvas, Rect rect, Paint paint) {
        Path path = new Path();
        int cornerLength = Math.min(rect.width(), rect.height()) / 4;
